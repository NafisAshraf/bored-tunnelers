...
const ElementTwo = () => {
  return (
    <div
      ...
      style={{ borderWidth: "20px", padding: "0px" }}
    >
      <div className="row">
        ...
        <div className="col-md-6">
          <div className="d-flex flex-column align-items-start justify-content-center h-100">
            ...
            >
              The Boring Company’s goal is to build the tunnel infrastructure to
              enable fast, safe, and comfortable transportation tunnel.
            </p>
            <p
              className="special dynamic-text text-black"
              style={{ textAlign: "left" }}
